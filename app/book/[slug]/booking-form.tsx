      ...
      <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-6 space-y-5">
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            <label
              htmlFor="guest_name"
              className="text-xs font-medium uppercase tracking-wider text-zinc-100">
              Your name
            </label>
            <input
              id="guest_name"
...
export default function BookingForm({
  ...
  // Track last scrolled selection to avoid re-scrolling on unrelated rerenders
          ...
          return (
            <div key={day} className="space-y-2.5">
              ...
              <div className="flex flex-wrap gap-2">
                {slots.map((slot) => {
                  const isSelected = isDaySelected && selected?.time === slot;
